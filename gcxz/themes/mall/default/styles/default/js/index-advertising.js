(function(a){
    a.fn.ggqh=function(p){
        ...
        s_s_n(F.find(".index_num"),x,w,z,A,B,C);
        ...
        F.find(".index_num").children("li").hover(
            function(){
                stop($(this));
            },
            function(){
        ...
        function play(){
            if(n=="enable"){
                ...
                F.find(".index_num").children("li").css("background-color",z);
                F.find(".index_num").children("li").children("a").css("color",x);
                F.find(".index_num").children("li").eq(E).css("background-color",A);
                F.find(".index_num").children("li").eq(E).children("a").css("color",button_current_text_color);
                E++;
                if(E>=G){
                    E=0
                }
        ...
        function stop(a){
            ...
            if(b != (E-1)){
                ...
                F.find(".index_num").children("li").css("background-color",z);
                F.find(".index_num").children("li").eq(b).css("background-color",A)
            }
        }
        function s_s_ul(a,b,c,d,e,f,g,h,i,l_g){
            ...
            a.children("li").children("p").css("background-color",h).css("color",i).css('width',parseInt(c));
            b=parseInt(b);
            c=parseInt(c);
            d=parseInt(d);
            e=parseInt(e);
