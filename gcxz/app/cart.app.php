...
class CartApp extends MallbaseApp
{
    ...
    function add()
    {
        ...
        $spec_info  =  $spec_model->get(array(
            'fields'        => 'g.store_id, g.goods_id, g.goods_name, g.spec_name_1, g.spec_name_2, g.default_image, gs.spec_1, gs.spec_2,g.source_type, gs.stock, gs.price',
            'conditions'    => $spec_id,
        ...
        $cart_item = array(
            ...
            'quantity'      => $quantity,
            'source_type'   => $spec_info['source_type'],
