...
// 					if ($needInstall) {
// 						// 安装货到付款
// 						$this->installPayment ( $store_id );
// 						// 安装配送方式ems
// 						$this->installShipping($store_id);
// 					}
     ...
     * 安装支付方式
     */
    function installPayment($store_id){
    	$data = array(
    			'store_id'      => $store_id,
    			'payment_name'  => '货到付款',
    			'payment_code'  => 'cod',
    	...
    	$model_payment->install($data);
    }
    
    /**
     * 安装配送方式
     */
    function installShipping($store_id){
     $data = array(
                'store_id'      => $store_id,
                'shipping_name' => 'EMS',
                'shipping_desc' => '',
