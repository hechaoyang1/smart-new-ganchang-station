...
class GoodsModel extends BaseModel
{
    ...
    function get_list($params = array(), $scate_ids = array(), $desc = false, $no_picture = true)
    {
        ...
        $fields = "g.goods_id, g.store_id, g.type, g.goods_name, g.sub_goods_name,g.cate_id, g.cate_name, g.brand, g.spec_qty, g.spec_name_1, g.spec_name_2, g.if_show,g.is_fine,g.is_red, g.closed, g.add_time, g.recommended, g.default_image,g.source_type,g.foreign_url, " .
                "gs.spec_id, gs.spec_1, gs.spec_2, gs.color_rgb, gs.price,gs.price1, gs.stock,g.unit," .
                "s.store_name, s.region_id, g.region_name, s.credit_value, s.sgrade, " .
